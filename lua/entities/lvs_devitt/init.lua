...
function ENT:OnSpawn( PObj )
	...
	//FRONT ARMOR
	self:AddArmor( Vector(80,0,40), Angle( 0,0,0 ), Vector(-10,-35,-15), Vector(10,35,45), 600, self.FrontArmor )

	//LEFT ARMOR
	self:AddArmor( Vector(15,45,65), Angle( 0,0,0 ), Vector(-100,-10,-10), Vector(60,10,20), 200, self.SideArmor )
	...
	//TURRET ARMOR
	local TurretArmor = self:AddArmor( Vector(20,0,85), Angle(0,0,0), Vector(-35,-35,0), Vector(35,35,35), 600, self.TurretArmor )
