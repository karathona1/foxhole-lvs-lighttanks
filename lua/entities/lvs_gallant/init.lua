...
function ENT:OnSpawn( PObj )
	...
	//FRONT ARMOR
	self:AddArmor( Vector(73,0,40), Angle( -25,0,0 ), Vector(-10,-35,-15), Vector(10,35,38), 700, self.FrontArmor )

	//LEFT ARMOR
	self:AddArmor( Vector(0,35,65), Angle( 0,0,0 ), Vector(-70,-5,-10), Vector(50,5,10), 400, self.SideArmor )

	//RIGHT ARMOR
	self:AddArmor( Vector(0,-35,65), Angle( 0,0,0 ), Vector(-70,-5,-10), Vector(50,5,10), 400, self.SideArmor )

	//BACK ARMOR
	self:AddArmor( Vector(-85,0,48), Angle( 0,0,0 ), Vector(-7,-30,-20), Vector(7,30,20), 200, self.BackArmor )


	//TURRET ARMOR
	local TurretArmor = self:AddArmor( Vector(15,10,70), Angle(0,0,0), Vector(-35,-25,5), Vector(35,25,30), 600, self.TurretArmor )
