...
if SERVER then
	...
	function ENT:TracksCreate( PObj )
		...
		local LeftTracksArmor = self:AddArmor( Vector(40,41,44), Angle(0,0,0), Vector(-115,-15,-45), Vector(35,15,0), 800, self.FrontArmor )
		...
		local RightTracksArmor = self:AddArmor( Vector(40,-41,44), Angle(0,0,0), Vector(-115,-15,-45), Vector(35,15,0), 800, self.FrontArmor )
	...
	ENT.TrackScrollTexture = "vehicles/actaeon/LightTankTreadCol"
	ENT.ScrollTextureData = {
		["$bumpmap"] = "vehicles/actaeon/LightTankTreadColN",
		["$color2"] = "[1.5 1.5 1.5]",
		["$phong"] = "1",
		["$phongboost"] = "1",
		["$phongexponent"] = "300",
