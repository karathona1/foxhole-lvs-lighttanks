...
if SERVER then
	...
	function ENT:TracksCreate( PObj )
		...
		local LeftTracksArmor = self:AddArmor( Vector(10,42,54), Angle(0,0,0), Vector(-115,-10,-55), Vector(80,10,0), 900, self.FrontArmor )
		...
		local RightTracksArmor = self:AddArmor( Vector(10,-42,54), Angle(0,0,0), Vector(-115,-10,-55), Vector(80,10,0), 900, self.FrontArmor )
	...
	ENT.TrackScrollTexture = "vehicles/pelekys/LightTankTreadCol"
	ENT.ScrollTextureData = {
		["$bumpmap"] = "vehicles/pelekys/LightTankTreadColN",
		["$color2"] = "[1.5 1.5 1.5]",
		["$phong"] = "1",
		["$phongboost"] = "1",
		["$phongexponent"] = "300",
